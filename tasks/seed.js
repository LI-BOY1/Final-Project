...
async function main(){
    ...
    const trainer_1 = await trainers.addTrainer("Joe", "Watson", info,"201-7832388", "yexiny@stevens.edu", "66 Hoboken Ave, Jersey City, NJ",  "Goirl", "W1sdsd23456", img);
    const trainerAcc_1 = await members.addMember("Joe", "Watson", "201-7832388", "yexiny@stevens.edu", "66 Hoboken Ave, Jersey City, NJ",  "Goirl", "W1sdsd23456");
    ...
    const trainerAcc_2 = await members.addMember("Cristina", "Ye", "922-7123388", "yec@outlook.com", "147 33rd Ave, Great Neck, NY",  "Hello123", "W1sdsd23456");
    ...
    const trainerAcc_3 = await members.addMember("trainer3", "Ben3", "6753-7579388", "sdsdadsa@outk.acom", "148 33rd, Great Neck, NJ",  "Hello123", "W1sdsd23456");
    ...
    const trainerAcc_4 = await members.addMember("John", "Ben", "123-7579388", "sdsa@outloaok.acom", "148 33rd Ave, Great Neck, NY",  "Hello123", "W1sdsd23456");
    ...
    const trainerAcc_5 = await members.addMember("Black", "Tim", "345-7123379", "yasdsdc@outlook.com", "149 33rd Ave, Small Neck, NY",  "Hello123", "W1sdsd23456");
    ...
    const trainerAcc_6 = await members.addMember("Ben", "Gold", "678-71783388", "yasdac@outslook.com", "111 33rd Ave, Great Neck, NY",  "Hello123", "W1sdsd23456");
    ...
    const trainerAcc_7 = await members.addMember("Yo", "Parker", "468-7123981", "asdac@outlsook.com", "123 33rd St, Great Neck, NY",  "Hello123", "W1sdsd23456");
    ...
    const trainerAcc_8 = await members.addMember("Jenny", "Li", "784-71111388", "yasdac@outadsook.com", "124 33rd St, Great Neck, NY",  "Hello123", "W1sdsd23456");
    ...
    const trainerAcc_9 = await members.addMember("Yi", "Tim", "145-71234588", "asdc@outlasdok.com", "126 33rd Ave, Great Neck, NY",  "Hello123", "W1sdsd23456");
    ...
    const trainerAcc_10 = await members.addMember("Trainer10", "Tim", "566-71234588", "asdc@ou66tlasdok.com", "126 32rd , Great Neck, NY", "Hello123", "W1sdsd6");
